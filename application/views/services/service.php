			...
			<div class="card">
				...
				<div class="card-body">
					<div class="btn-popup pull-right">
						<button type="button" class="btn btn-secondary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Service</button>
						<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title f-w-600" id="exampleModalLabel">Add Service</h5>
										<button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
									</div>
									<div class="modal-body">
										<form class="needs-validation" id="frmService" method="post" action="<?=base_url('Services/create_service')?>">
...
<!--												</div>-->
												<div class="form-group">
													...
													<input class="form-control" id="txtService" name="txtService" maxlength="50" minlength="3" type="text">
												</div>
<!--												<div class="form-group">-->
...
<!--								<th class="text-center">Company Name</th>-->
							...
							<tbody id="showReportService"></tbody>
						</table>
					</div>
				</div>
			</div>
