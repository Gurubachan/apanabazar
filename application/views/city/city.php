            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add City</button>
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title f-w-600" id="exampleModalLabel">Add City</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="needs-validation" id="frmCity" method="post" action="<?=base_url('City/create_city')?>">
                                            ...
                                            <div class="form">
												...
												<div class="form-group">
                                                    <label for="validationCustom01" class="mb-1">District id:</label>
                                                    <select name="cboDistrict" class="form-control" id="cboDistrict">
                                                        <option value="0">Select District</option>
                                                        <option value="1">Khurdha</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="validationCustom01" class="mb-1">Code:</label>
                                                    <input class="form-control" id="txtCode" name="txtCode"  type="text" maxlength="4" minlength="4">
                                                </div>
                                                <div class="form-group">
