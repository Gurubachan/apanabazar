	...
	<div class="page-sidebar">
		...
		<div class="sidebar custom-scrollbar">
			...
			<ul class="sidebar-menu">
					...
					<ul class="sidebar-submenu">
						<li>
							...
							<ul class="sidebar-submenu">
								...
								<li><a href="<?=base_url('Manufacturer/')?>"><i class="fa fa-circle"></i>Manufacturers</a></li>
								<li><a href="add-product.html"><i class="fa fa-circle"></i>Add Items</a></li>
							</ul>
						</li>
						<li>
							<a href="#"><i class="fa fa-circle"></i>
								<span>Digital</span> <i class="fa fa-angle-right float-right"></i>
							</a>
							<ul class="sidebar-submenu">
				...
				<li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Pages</span><i class="fa fa-angle-right float-right"></i></a>
					<ul class="sidebar-submenu">
	...
	<div class="right-sidebar" id="right_side_bar">
		<div>
			...
			<div class="friend-list-search mt-0">
				<input type="text" placeholder="search friend"><i class="fas fa-search"></i>
			</div>
